...
| :-------------- | :------------------------------------------- | :----------------------------------------------- | :---------------------------------------------- | :---------------------------------------------- | :---------------------------------------------- |
| 1 RAMからロード | RAM[rs1] => RS1                              | RAM[rs1] => RS1<br/>計算 : ALU(RS1,**imm**,func) | RAM[rs1] => RS1<br/>計算 : ALU(RS1,**imm**,add) | RAM[rs1] => RS1<br/>計算 : ALU(RS1,**imm**,add) | RAM[rs1] => RS1<br/>計算 : ALU(RS1,**imm**,add) |
| 2 RAMからロード | RAM[rs2] => RS2<br/>計算 : ALU(RS1,RS2,func) |                                                  | RAM[ALU] => RS2                                 | RAM[rs2] => RS2                                 | RAM[rs2] => RS2<br/>分岐判定 : IS_ZERO(RS2)     |
| 3 RAMへストア   | ALU => RAM[rd]                               | ALU => RAM[rd]                                   | RS2 => RAM[rd]                                  | RS2 => RAM[ALU]                                 | PC+1 => RAM[rd]                                 |
| 4 PC変更        | PC+1 => PC                                   | PC+1 => PC                                       | PC+1 => PC                                      | PC+1 => PC                                      | IS_ZERO ? ALU : PC+1 => PC                      |
...
割り込み許可を1クロック遅延させるのは、割り込みリターンのところで割り込みが発生するのを防ぐためです。
