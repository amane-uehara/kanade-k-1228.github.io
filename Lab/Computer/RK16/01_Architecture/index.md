...
| :------- | :------------------------------------ | :------------------------------------ | :----------------------------------- | :----------------------------------- | :----------------------------------- |
| 1 ロード | RAM[rs1] => RS1<br/>                  | RAM[rs1] => RS1<br/>ALU(RS1,imm,func) | RAM[rs1] => RS1<br/>ALU(RS1,imm,add) | RAM[rs1] => RS1<br/>ALU(RS1,imm,add) | RAM[rs1] => RS1<br/>ALU(RS1,imm,add) |
| 2 ロード | RAM[rs2] => RS2<br/>ALU(RS1,RS2,func) |                                       | RAM\[**ALU**] => RS2<br/>            | RAM[rs2] => RS2<br/>                 | RAM[rs2] => RS2<br/>IS_ZERO(RS2)     |
...
命令に合わせて、各ステージの長さを調整することで、クロックを上げられます。
