...
サンプリング定理を考えるとわかるように、$k=k_0\pm n\f{\pi}{a}$ の波数の波を区別できない。
...
$$
\phi = \phi_0 + \f{K}{2}\sum_i\l{u_1(na)-u_2(na+d)\}^2 + \f{G}{2}\sum_i\l{u_2(na+d)-u_1(na+a)\}^2
$$

$a>d$ の近似を用いて

$$
\phi = \phi_0 + \f{K}{2}\sum_i\l{u_1(na)-u_2(na)\}^2 + \f{G}{2}\sum_i\l{u_2(na)-u_1(na+a)\}^2
$$
